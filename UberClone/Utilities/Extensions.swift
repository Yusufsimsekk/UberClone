...
extension UIView {
    ...
    func inputContainerView(image: UIImage, textField: UITextField? = nil ,
        ...
        if let segmentedControl = segmentedControl {
            imageView.anchor(top: view.topAnchor, left: view.leftAnchor, paddingLeft: 8, height: 24, width: 24)
            view.addSubview(segmentedControl)
            segmentedControl.anchor( right: view.rightAnchor, left: view.leftAnchor, paddingLeft: 8, paddingRight: 8)
