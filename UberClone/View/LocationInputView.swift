...
//    MARK: - Lifecycle
    override init(frame: CGRect) {
        ...
        backButton.anchor(top: safeAreaLayoutGuide.topAnchor, left: leftAnchor, paddingTop: 10, paddingLeft: 12, height: 24, width: 25)
        ...
        startingLocationTextField.anchor(top: titleLabel.bottomAnchor, right: rightAnchor,
                                         left: leftAnchor, paddingTop: 10,
        ...
        destinationLocationTextField.anchor(top: startingLocationTextField.bottomAnchor,
                                            right: rightAnchor, left: leftAnchor, paddingTop: 10,
                                            paddingLeft: 40,paddingRight: 40, height: 30)
